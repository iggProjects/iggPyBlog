...
if __name__ == "__main__":
    ...
    """
    class musicalTeam(musicians,musicalInstruments):
        def __init__(self,musician_name,inst_name,inst_type,inst_prize,inst_keys):
            musicalInstruments.__init__(self,inst_name,inst_type,inst_prize,inst_keys)            
            self.musician_name = musician_name
            self.inst_name = inst_name
    ...
    print(f"\nmro of musicalTeam: {musicalTeam.__mro__}\n")
    for clas in musicalTeam.__mro__:
        print(f"\nclass: {clas}")
