...
if __name__ == "__main__":
	...
	try:
		...
		mostrar_matriz1(matriz,"matriz = np.arange(nX*nY).reshape(nX, nY)")
		...
		mostrar_matriz1(m0,"Matriz m0:  matriz[ 0:int(nX/2), 0:int(nY/2) ]")
		mostrar_matriz1(m1,"Matriz m1:  matriz[int(nX/2):nX, 0:int(nY/2) ]")
		mostrar_matriz1(m2,"Matriz m2:  matriz[ 0:int(nX/2), int(nY/2):nY ]")
		mostrar_matriz1(m3,"Matriz m3:  matriz[ int(nX/2):nX, int(nY/2):nY ]")
		...
		print("print empty line")
		mostrar_matriz1(m0e,"m0e: expandir_matriz(m0, m1, m2, m3)")
		mostrar_matriz1(m1e,"m1e: expandir_matriz(m1, m0, m3, m2)")
		mostrar_matriz1(m2e,"m2e: expandir_matriz(m2, m3, m0, m1)")
		mostrar_matriz1(m3e,"m3e: expandir_matriz(m3, m2, m1, m0)")
		...
		mostrar_matriz1(m0c,"m0c: contraer_matriz(m0e)")
		mostrar_matriz1(m1c,"m1c: contraer_matriz(m1e)")
		mostrar_matriz1(m2c,"m2c: contraer_matriz(m2e)")
		mostrar_matriz1(m3c,"m3c: contraer_matriz(m3e)")

		print(f"{FR_GREEN}\n====== MATRIZ FINAL COMPLETA ======\n{NO_COLOR}")
		print("print empty line")
		matrizFinal = np.hstack( (np.vstack( (m0c, m1c) ), np.vstack( (m2c, m3c) )) )
		mostrar_matriz1(matrizFinal,"Matriz Final: np.hstack( (np.vstack( (m0c, m1c) ), np.vstack( (m2c, m3c) )) )")
