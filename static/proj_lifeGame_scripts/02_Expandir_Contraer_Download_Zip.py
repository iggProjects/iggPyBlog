...
if __name__ == "__main__":
    ...
    fileNameZip = fileNameZip.replace('Expandir_Contraer_Download_Zip.py','LG_Expandir_Contraer')
    ...
    zipFilesInList(list_paths, file_zip_path, lambda name: 'funciones_DL' in name)
