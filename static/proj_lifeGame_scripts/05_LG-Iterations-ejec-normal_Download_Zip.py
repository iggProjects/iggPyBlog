...
if __name__ == "__main__":
    ...
    fileNameZip = fileNameZip.replace('Iterations-ejec-normal_Download_Zip.py','iterations-ejec-normal')
    ...
    zipFilesInList(list_paths, file_zip_path, lambda name: 'normal_DL' in name)
