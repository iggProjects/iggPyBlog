...
if __name__ == "__main__":
    ...
    fileNameZip = fileNameZip.replace('iterations-funciones_Download_Zip.py','iterations-funciones')
    ...
    zipFilesInList(list_paths, file_zip_path, lambda name: 'ons-funciones_DL' in name)
