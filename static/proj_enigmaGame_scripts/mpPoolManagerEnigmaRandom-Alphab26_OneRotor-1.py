...
alphab = list('yzxuqrbapsfwjdtgiomhvelckn')
...
def decipher(alphab1, event):
    ...
    if event.is_set():
        ...
        for jump in range(27):
            alphab_temp = alphab1[-jump:] + alphab1[:-jump]
            alphab_list.append(alphab_temp)
        ...
        print(f"\t\t\t====> decoded message: {decoded_msg} | alphab: {alphab1}")   
